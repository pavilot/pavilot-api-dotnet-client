...
namespace Pavilot.Api.Client
{
    ...
    public partial class PavilotClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<Asset>> V1ProjectsAnimationsAudiosGetAsync(string projectId, string animationId)
        {
            return V1ProjectsAnimationsAudiosGetAsync(projectId, animationId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<Asset>> V1ProjectsAnimationsAudiosGetAsync(string projectId, string animationId, System.Threading.CancellationToken cancellationToken)
        {
            if (projectId == null)
                throw new System.ArgumentNullException("projectId");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/v1/projects/{projectId}/animations/{animationId}/audios");
            urlBuilder_.Replace("{projectId}", System.Uri.EscapeDataString(ConvertToString(projectId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{animationId}", System.Uri.EscapeDataString(ConvertToString(animationId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Asset> V1ProjectsAnimationsAudiosPostAsync(string projectId, string animationId, System.IO.FileStream file)
        {
            return V1ProjectsAnimationsAudiosPostAsync(projectId, animationId, file, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Asset> V1ProjectsAnimationsAudiosPostAsync(string projectId, string animationId, System.IO.FileStream file, System.Threading.CancellationToken cancellationToken)
        {
            if (projectId == null)
                throw new System.ArgumentNullException("projectId");
